...
def main():
    ...
    # parser.add_argument('audiofile', default=sys.stdin, help="Audio file to be sent to the server", type=argparse.FileType('rb'))
    parser.add_argument('audiofile', default='./test/data/bill_gates-TED.mp3', help="Audio file to be sent to the server",
